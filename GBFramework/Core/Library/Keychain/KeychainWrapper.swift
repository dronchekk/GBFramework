...
protocol KeychainWrapper {
    ...
    @discardableResult
    func set(_ value: String, forKey key: String, withAccessibility accessibility: KeychainItemAccessibility?, isSynchronizable: Bool) -> Bool

    @discardableResult
    func removeObject(forKey key: String) -> Bool
    @discardableResult
    func removeObject(forKey key: String, withAccessibility accessibility: KeychainItemAccessibility?, isSynchronizable: Bool) -> Bool
}

extension KeychainWrapper {

    func string(forKey key: String) -> String? {
        self.string(forKey: key, withAccessibility: nil, isSynchronizable: false)
    }

    @discardableResult
    func set(_ value: String, forKey key: String) -> Bool {
        self.set(value, forKey: key, withAccessibility: nil, isSynchronizable: false)
    }

    @discardableResult
    func removeObject(forKey key: String) -> Bool {
        self.removeObject(forKey: key, withAccessibility: nil, isSynchronizable: false)
    }
}
...
open class KeychainWrapperImpl: KeychainWrapper {
    ...
    public static let defaultKeychainWrapper = KeychainWrapperImpl.standard

    /// Default keychain wrapper access
    public static let standard = KeychainWrapperImpl()
    ...
    private convenience init() {
        self.init(serviceName: KeychainWrapperImpl.defaultServiceName)
    }
